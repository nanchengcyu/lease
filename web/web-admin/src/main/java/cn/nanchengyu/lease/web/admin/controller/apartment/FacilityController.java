...
import cn.nanchengyu.lease.web.admin.service.FacilityInfoService;
...
public class FacilityController {
    ...
    public Result<List<FacilityInfo>> listFacility(@RequestParam(required = false) ItemType type) {
        List<FacilityInfo> list =  facilityInfoService.list(new LambdaQueryWrapper<FacilityInfo>().eq(type != null, FacilityInfo::getType, type));
