...
import cn.nanchengyu.lease.web.admin.vo.apartment.ApartmentItemVo;
import cn.nanchengyu.lease.web.admin.vo.apartment.ApartmentQueryVo;
import cn.nanchengyu.lease.web.admin.vo.apartment.ApartmentSubmitVo;
...
public class ApartmentController {
    ...
    public Result<ApartmentDetailVo> getDetailById(@RequestParam Long id) {
        ApartmentDetailVo apartmentInfo = service.getDetailById(id);
